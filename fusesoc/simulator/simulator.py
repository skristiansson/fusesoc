    ...
    def __init__(self, system):
        ...
        for core_name in self.cores:
            ...
            if core.verilator:
                ...
                self.verilator.tb_include_dirs      += [os.path.join(self.src_root, core_name, d) for d in core.verilator.tb_include_dirs]
                ...
                if core_name == self.system.name:
                    self.verilator.src_files        += [f for f in core.verilator.tb_private_src_files]
